...
public class APBaseC extends LinearOpMode {
...
/*
 ...
 double r = Math.hypot(gamepad1.left_stick_x, gamepad1.left_stick_y);
       ...
       double forward=  robotAngle - heading;  
            double rightX = gamepad1.right_stick_x;
            final double leftFrontPwr = r * Math.cos(forward) + rightX;
            final double rightFrontPwr = r * Math.sin(forward) - rightX;
            final double rightRearPwr = r * Math.sin(forward) + rightX;
            final double leftRearPwr = r * Math.cos(forward) - rightX;
            ...
            armMotor2.setPower(gamepad2.right_trigger);
